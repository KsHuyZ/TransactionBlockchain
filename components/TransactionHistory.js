...
const style = {
  wrapper: `h-full text-white select-none h-full w-screen flex-1 pt-14 flex items-end justify-end overflow-scroll-y pb-12 px-8`,
  ...
  useEffect(() => {
    const handleGetTransactionList = async () => {
      if (!isLoading && currentAccount) {
        ...
        console.log("client:", clientRes[0]);
